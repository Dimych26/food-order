...
namespace Tests
{
    ...
    public class DishServiceTest
    {
        ...
        [Test]
        public void Create_TryToCreateNullElement_ShouldThrowException()
        {
            Assert.Throws<ArgumentNullException>(() => dishService.AddDish(null));
        }
        ...
        [Test]
        public void Edit_TryToEditNullElement_ShouldThrowException()
        {
            Assert.Throws<ArgumentNullException>(() => dishService.Update(null));
        }
        ...
        [Test]
        public void Remove_TryToRemoveNonExistingElement_ShouldThrowExceptions()
        {
            dishRepository.Setup(x => x.GetOne(It.IsAny<Func<Dish, bool>>())).Returns<Dish>(null);

            Assert.Throws<ArgumentNullException>(() => dishService.DeleteDish(It.IsAny<int>()));
        }
